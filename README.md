## Welcome to the emandates BETA swagger specification
...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://whelanp.github.io/emandates-swagger/docs/redoc.html). 
